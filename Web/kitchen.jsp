...
<head>
    ...
    <title>Heaven And Home | Kitchen Furniture</title>
...
<body>
    <%
        ...
        DB db = new DB();
        List<Product> products = db.getProductsByType("kitchen");
    %>
    ...
    <div class="product-list">
        <% if (products.isEmpty()) { %>
            <div style="text-align: center; padding: 50px;">
                <h3>No kitchen products found.</h3>
