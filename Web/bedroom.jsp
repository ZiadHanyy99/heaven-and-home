...
<head>
    ...
    <title>Heaven And Home | Bedroom Furniture</title>
...
<body>
    <%
        ...
        DB db = new DB();
        List<Product> products = db.getProductsByType("bedroom");
    %>
    ...
    <div class="product-list">
        <% if (products.isEmpty()) { %>
            <div style="text-align: center; padding: 50px;">
                <h3>No bedroom products found.</h3>
